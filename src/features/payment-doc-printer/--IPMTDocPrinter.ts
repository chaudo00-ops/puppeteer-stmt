...
export type TCreateInvoicePdfParams = Pick<TFields_v2_payments, "payment_id" | "sub_acc_id">;

export type TCreateBillingStatementPdfParams = {
	sub_acc_id: string;
	month: Date;
	language?: "en" | "zh-CN"; // Optional language parameter, defaults to "en"
};
...
export interface IPMTDocPrinter {
	...
	generateInvoicePdf(params: TCreateInvoicePdfParams): Promise<TCreateInvoiceResult>;
}
